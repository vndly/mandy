...
public class MotorJoint extends Joint {
  ...
  private final org.jbox2d.common.Mat22 m_linearMass = new org.jbox2d.common.Mat22();
  private float m_angularMass;

  public MotorJoint(org.jbox2d.pooling.IWorldPool pool, MotorJointDef def) {
    super(pool, def);
  ...
  public void initVelocityConstraints(org.jbox2d.dynamics.SolverData data) {
    ...
    org.jbox2d.common.Mat22 K = pool.popMat22();
    ...
    org.jbox2d.common.Rot.mulToOutUnsafe(qA, m_linearOffset, temp);
  ...
  public void solveVelocityConstraints(org.jbox2d.dynamics.SolverData data) {
    ...
    // Solve angular friction
    {
      ...
      m_angularImpulse = org.jbox2d.common.MathUtils.clamp(m_angularImpulse + impulse, -maxImpulse, maxImpulse);
    ...
    // Solve linear friction
    {
      ...
      org.jbox2d.common.Mat22.mulToOutUnsafe(m_linearMass, Cdot, impulse);
      impulse.negateLocal();
