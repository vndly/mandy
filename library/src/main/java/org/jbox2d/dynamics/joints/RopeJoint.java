...
public class RopeJoint extends Joint {
  ...
  protected RopeJoint(org.jbox2d.pooling.IWorldPool worldPool, RopeJointDef def) {
    super(worldPool, def);
  ...
  public void solveVelocityConstraints(final org.jbox2d.dynamics.SolverData data) {
    ...
    m_impulse = org.jbox2d.common.MathUtils.min(0.0f, m_impulse + impulse);
  ...
  public boolean solvePositionConstraints(final org.jbox2d.dynamics.SolverData data) {
    ...
    C = org.jbox2d.common.MathUtils.clamp(C, 0.0f, Settings.maxLinearCorrection);
