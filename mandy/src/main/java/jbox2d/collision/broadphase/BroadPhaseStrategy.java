...
public interface BroadPhaseStrategy {
   ...
   * @return
   */
  int createProxy(jbox2d.collision.AABB aabb, Object userData);
   ...
   */
  boolean moveProxy(int proxyId, jbox2d.collision.AABB aabb, Vec2 displacement);
  
  Object getUserData(int proxyId);

  jbox2d.collision.AABB getFatAABB(int proxyId);
   ...
   * @param araabbgAABB
   */
  void query(jbox2d.callbacks.TreeCallback callback, jbox2d.collision.AABB aabb);
   ...
   */
  void raycast(jbox2d.callbacks.TreeRayCastCallback callback, jbox2d.collision.RayCastInput input);
  ...
  void drawTree(jbox2d.callbacks.DebugDraw draw);
}