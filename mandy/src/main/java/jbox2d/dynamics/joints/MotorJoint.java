...
public class MotorJoint extends Joint {
  ...
  private final jbox2d.common.Mat22 m_linearMass = new jbox2d.common.Mat22();
  private float m_angularMass;

  public MotorJoint(jbox2d.pooling.IWorldPool pool, MotorJointDef def) {
    super(pool, def);
  ...
  public void initVelocityConstraints(jbox2d.dynamics.SolverData data) {
    ...
    jbox2d.common.Mat22 K = pool.popMat22();
    ...
    jbox2d.common.Rot.mulToOutUnsafe(qA, m_linearOffset, temp);
  ...
  public void solveVelocityConstraints(jbox2d.dynamics.SolverData data) {
    ...
    // Solve angular friction
    {
      ...
      m_angularImpulse = jbox2d.common.MathUtils.clamp(m_angularImpulse + impulse, -maxImpulse, maxImpulse);
    ...
    // Solve linear friction
    {
      ...
      jbox2d.common.Mat22.mulToOutUnsafe(m_linearMass, Cdot, impulse);
      impulse.negateLocal();
