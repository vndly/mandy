...
public class RopeJoint extends Joint {
  ...
  protected RopeJoint(jbox2d.pooling.IWorldPool worldPool, RopeJointDef def) {
    super(worldPool, def);
  ...
  public void solveVelocityConstraints(final jbox2d.dynamics.SolverData data) {
    ...
    m_impulse = jbox2d.common.MathUtils.min(0.0f, m_impulse + impulse);
  ...
  public boolean solvePositionConstraints(final jbox2d.dynamics.SolverData data) {
    ...
    C = jbox2d.common.MathUtils.clamp(C, 0.0f, Settings.maxLinearCorrection);
