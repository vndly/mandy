...
public interface BroadPhaseStrategy {
   ...
   * @return
   */
  int createProxy(org.jbox2d.collision.AABB aabb, Object userData);
   ...
   */
  boolean moveProxy(int proxyId, org.jbox2d.collision.AABB aabb, Vec2 displacement);
  
  Object getUserData(int proxyId);

  org.jbox2d.collision.AABB getFatAABB(int proxyId);
   ...
   * @param araabbgAABB
   */
  void query(org.jbox2d.callbacks.TreeCallback callback, org.jbox2d.collision.AABB aabb);
   ...
   */
  void raycast(org.jbox2d.callbacks.TreeRayCastCallback callback, org.jbox2d.collision.RayCastInput input);
  ...
  void drawTree(org.jbox2d.callbacks.DebugDraw draw);
}